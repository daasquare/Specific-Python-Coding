...
####### Read the Excel file #######
excel_file = pd.ExcelFile('/Users/akin.o.akinjogbin/Desktop/July 2023 Tine Testing Raw data/Pull Test/Batch 2 Test Data (12mm Pocket)/Presentation/ProcessedData.xlsx')
...
for i, sheet_name in enumerate(excel_file.sheet_names):
   ...
   # ax.plot(initial_peak_x, initial_peak_y, 'ro', label='Phase One')
    ax.plot(max_peak_x, max_peak_y, 'ro', label='Peak Retension Force')

# Set plot labels and title
ax.set_xlabel('Distance (mm)', fontdict=font2)
ax.set_ylabel('Force (mm)', fontdict=font5)
ax.set_title('Test 2A PeaK Retension', fontdict=font1)
